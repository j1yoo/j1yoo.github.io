...
# Run selected lines in order in RStudio. "PDF p." refers to the 52-page slides.
...
# PDF p. 49-51  In-class exercise E1 (Gapminder): write your own code here and upload it to eeclass.
